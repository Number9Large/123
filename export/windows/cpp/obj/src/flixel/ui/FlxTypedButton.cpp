...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton","updateStatusAnimation",0x00250d0d,"flixel.ui.FlxTypedButton.updateStatusAnimation","flixel/ui/FlxButton.hx",302,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(303)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton","updateStatus",0x83872af7,"flixel.ui.FlxTypedButton.updateStatus","flixel/ui/FlxButton.hx",453,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_ARG(input,"input")
		HX_STACK_LINE(454)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton","updateLabelPosition",0x7d4d6d98,"flixel.ui.FlxTypedButton.updateLabelPosition","flixel/ui/FlxButton.hx",474,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(475)
		::flixel::FlxSprite tmp = this->_spriteLabel;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(475)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton","updateLabelAlpha",0x2352ff0f,"flixel.ui.FlxTypedButton.updateLabelAlpha","flixel/ui/FlxButton.hx",483,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(484)
		::flixel::FlxSprite tmp = this->_spriteLabel;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(484)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton","onUpEventListener",0x0f960298,"flixel.ui.FlxTypedButton.onUpEventListener","flixel/ui/FlxButton.hx",496,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(497)
...
bool FlxTypedButton_obj::get_justReleased( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton","get_justReleased",0x06e7426e,"flixel.ui.FlxTypedButton.get_justReleased","flixel/ui/FlxButton.hx",594,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(595)
	::flixel::input::FlxInput tmp = this->input;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(595)
...
bool FlxTypedButton_obj::get_released( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton","get_released",0xa9c8d9a2,"flixel.ui.FlxTypedButton.get_released","flixel/ui/FlxButton.hx",599,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(600)
...
bool FlxTypedButton_obj::get_pressed( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton","get_pressed",0x0c35e55d,"flixel.ui.FlxTypedButton.get_pressed","flixel/ui/FlxButton.hx",604,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(605)
	bool tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(605)
...
bool FlxTypedButton_obj::get_justPressed( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton","get_justPressed",0x7ad59a11,"flixel.ui.FlxTypedButton.get_justPressed","flixel/ui/FlxButton.hx",609,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(610)
	::flixel::input::FlxInput tmp = this->input;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(610)
