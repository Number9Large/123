...
{
		HX_STACK_FRAME("flixel.ui.FlxButton","initLabel",0xd1ec8c72,"flixel.ui.FlxButton.initLabel","flixel/ui/FlxButton.hx",78,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Text,"Text")
		HX_STACK_LINE(79)
...
::String FlxButton_obj::get_text( ){
	HX_STACK_FRAME("flixel.ui.FlxButton","get_text",0x7dcfb448,"flixel.ui.FlxButton.get_text","flixel/ui/FlxButton.hx",89,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(90)
	::flixel::text::FlxText tmp = this->label;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(90)
