...
::String TrackerProfile_obj::toString( ){
	HX_STACK_FRAME("flixel.system.debug.watch.TrackerProfile","toString",0x9a236fa2,"flixel.system.debug.watch.TrackerProfile.toString","flixel/system/debug/watch/Tracker.hx",239,0x14368dcf)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
