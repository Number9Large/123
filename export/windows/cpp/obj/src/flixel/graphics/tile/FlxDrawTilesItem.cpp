...
Void FlxDrawTilesItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame,::flixel::math::FlxMatrix matrix,::openfl::_legacy::geom::ColorTransform transform){
{
		...
		HX_STACK_LINE(42)
		{
			...
			int tmp = (this->position)++;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(42)
			Float tmp1 = matrix->ty;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(42)
			this->drawData[tmp] = tmp1;
		}
		HX_STACK_LINE(44)
		...
		HX_STACK_LINE(49)
		{
			...
			int tmp = (this->position)++;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(49)
			Float tmp1 = rect->height;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(49)
			this->drawData[tmp] = tmp1;
		}
		HX_STACK_LINE(51)
		...
		HX_STACK_LINE(52)
		{
			...
			int tmp = (this->position)++;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(52)
			Float tmp1 = matrix->b;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(52)
			this->drawData[tmp] = tmp1;
		}
		HX_STACK_LINE(53)
		{
			...
			int tmp = (this->position)++;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(53)
			Float tmp1 = matrix->c;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(53)
			this->drawData[tmp] = tmp1;
		}
		HX_STACK_LINE(54)
		{
			...
			int tmp = (this->position)++;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(54)
			Float tmp1 = matrix->d;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(54)
			this->drawData[tmp] = tmp1;
		}
		HX_STACK_LINE(56)
		...
		if ((tmp1)){
			HX_STACK_LINE(58)
			{
				...
				HX_STACK_LINE(58)
				Float tmp3 = transform->redMultiplier;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(58)
			...
			HX_STACK_LINE(59)
			{
				...
				int tmp2 = (this->position)++;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(59)
				Float tmp3 = transform->greenMultiplier;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(59)
				this->drawData[tmp2] = tmp3;
			}
			HX_STACK_LINE(60)
			{
				...
				int tmp2 = (this->position)++;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(60)
				Float tmp3 = transform->blueMultiplier;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(60)
				this->drawData[tmp2] = tmp3;
			}
		}
		HX_STACK_LINE(63)
		{
			...
			if ((tmp3)){
				HX_STACK_LINE(63)
				tmp4 = transform->alphaMultiplier;
			}
			else{
				HX_STACK_LINE(63)
				tmp4 = ((Float)1.0);
...
{
		HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","setNext",0xf805b258,"flixel.graphics.tile.FlxDrawTilesItem.setNext","flixel/graphics/tile/FlxDrawTilesItem.hx",77,0xdffe6dcc)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(78)
		int tmp = (this->position)++;		HX_STACK_VAR(tmp,"tmp");
...
Void FlxDrawTilesItem_obj::render( ::flixel::FlxCamera camera){
{
		...
		HX_STACK_LINE(86)
		int tmp5 = (int)48;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(86)
		int tmp6 = (int(tmp5) | int((int)8));		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(86)
		int flags = tmp6;		HX_STACK_VAR(flags,"flags");
		HX_STACK_LINE(88)
		bool tmp7 = this->colored;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(88)
		if ((tmp7)){
			HX_STACK_LINE(89)
			hx::OrEq(flags,(int)4);
		...
		HX_STACK_LINE(96)
		int tmp8 = this->blending;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(96)
		hx::OrEq(flags,tmp8);
		HX_STACK_LINE(98)
		::openfl::_legacy::display::Graphics tmp9 = camera->canvas->get_graphics();		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(98)
		::flixel::graphics::FlxGraphic tmp10 = this->graphics;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(98)
		::openfl::_legacy::display::Tilesheet tmp11 = tmp10->get_tilesheet();		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(99)
		bool tmp12 = camera->antialiasing;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(99)
		...
		HX_STACK_LINE(98)
		tmp9->drawTiles(tmp11,this->drawData,tmp14,tmp15,tmp16);
		HX_STACK_LINE(103)
...
int FlxDrawTilesItem_obj::get_numVertices( ){
	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numVertices",0x8b0e8f99,"flixel.graphics.tile.FlxDrawTilesItem.get_numVertices","flixel/graphics/tile/FlxDrawTilesItem.hx",120,0xdffe6dcc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(121)
...
int FlxDrawTilesItem_obj::get_numTriangles( ){
	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numTriangles",0x37fe0d0b,"flixel.graphics.tile.FlxDrawTilesItem.get_numTriangles","flixel/graphics/tile/FlxDrawTilesItem.hx",125,0xdffe6dcc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(126)
	int tmp = this->get_numTiles();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(126)
...
Dynamic FlxDrawTilesItem_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"setNext") ) { return setNext_dyn(); }
		break;
	case 8:
