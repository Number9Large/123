...
struct _Function_0_1{
	inline static ::flixel::input::gamepad::FlxGamepadAnalogStick Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/XInputID.hx",119,0x9958eee3)
		{
			struct _Function_1_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/XInputID.hx",119,0x9958eee3)
					{
						...
						__result->Add(HX_HCSTRING("up","\x5b","\x66","\x00","\x00") , (int)21,false);
						__result->Add(HX_HCSTRING("down","\x62","\xf8","\x6d","\x42") , (int)22,false);
						__result->Add(HX_HCSTRING("left","\x07","\x08","\xb0","\x47") , (int)23,false);
						__result->Add(HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9") , (int)24,false);
						return __result;
					}
					return null();
				}
...
struct _Function_0_2{
	inline static ::flixel::input::gamepad::FlxGamepadAnalogStick Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/XInputID.hx",120,0x9958eee3)
		{
			struct _Function_1_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/gamepad/id/XInputID.hx",120,0x9958eee3)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_HCSTRING("up","\x5b","\x66","\x00","\x00") , (int)25,false);
						__result->Add(HX_HCSTRING("down","\x62","\xf8","\x6d","\x42") , (int)26,false);
						__result->Add(HX_HCSTRING("left","\x07","\x08","\xb0","\x47") , (int)27,false);
						__result->Add(HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9") , (int)28,false);
						return __result;
					}
					return null();
				}
			...
			Dynamic tmp = _Function_1_1::Block();		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(120)
			return ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)3,(int)4,tmp);
		}
		return null();
	}
};
