...
int PS4Mapping_obj::getID( int rawID){
	...
	switch( (int)(tmp)){
		...
		default: {
			...
			HX_STACK_LINE(45)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp3 = ::flixel::input::gamepad::id::PS4ID_obj::LEFT_ANALOG_STICK;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(45)
			...
			HX_STACK_LINE(46)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp7 = ::flixel::input::gamepad::id::PS4ID_obj::LEFT_ANALOG_STICK;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(46)
			...
			HX_STACK_LINE(47)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp11 = ::flixel::input::gamepad::id::PS4ID_obj::LEFT_ANALOG_STICK;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(47)
			...
			HX_STACK_LINE(48)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp15 = ::flixel::input::gamepad::id::PS4ID_obj::LEFT_ANALOG_STICK;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(48)
			...
			HX_STACK_LINE(49)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp19 = ::flixel::input::gamepad::id::PS4ID_obj::RIGHT_ANALOG_STICK;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(49)
			...
			HX_STACK_LINE(50)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp23 = ::flixel::input::gamepad::id::PS4ID_obj::RIGHT_ANALOG_STICK;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(50)
			...
			HX_STACK_LINE(51)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp27 = ::flixel::input::gamepad::id::PS4ID_obj::RIGHT_ANALOG_STICK;		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(51)
			...
			HX_STACK_LINE(52)
			::flixel::input::gamepad::FlxGamepadAnalogStick tmp31 = ::flixel::input::gamepad::id::PS4ID_obj::RIGHT_ANALOG_STICK;		HX_STACK_VAR(tmp31,"tmp31");
			HX_STACK_LINE(52)
...
int PS4Mapping_obj::axisIndexToRawID( int axisID){
	HX_STACK_FRAME("flixel.input.gamepad.mappings.PS4Mapping","axisIndexToRawID",0x10ca1942,"flixel.input.gamepad.mappings.PS4Mapping.axisIndexToRawID","flixel/input/gamepad/mappings/PS4Mapping.hx",96,0x24847fdd)
	HX_STACK_THIS(this)
