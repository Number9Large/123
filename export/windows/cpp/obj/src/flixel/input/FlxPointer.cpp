...
bool FlxPointer_obj::overlaps( ::flixel::FlxBasic ObjectOrGroup,::flixel::FlxCamera Camera){
	...
	if ((tmp2)){
		...
		Void run(::flixel::FlxBasic basic){
			HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","flixel/input/FlxPointer.hx",99,0xe6a2529b)
			HX_STACK_ARG(basic,"basic")
			{
				...
				HX_STACK_LINE(100)
				bool tmp5 = _g->overlaps(tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(100)
				if ((tmp5)){
					HX_STACK_LINE(102)
					result[(int)0] = true;
		...
		HX_STACK_LINE(109)
		::flixel::math::FlxPoint tmp3 = this->getPosition(null());		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(109)
		...
		HX_STACK_LINE(111)
		bool tmp6 = object->overlapsPoint(tmp4,true,tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(111)
		result[(int)0] = tmp6;
		HX_STACK_LINE(112)
		point->put();
	...
	HX_STACK_LINE(115)
	bool tmp3 = result->__get((int)0);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(115)
	return tmp3;
}
