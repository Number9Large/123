...
Float QuadMotion_obj::get_distance( ){
	...
	HX_STACK_LINE(76)
	::flixel::math::FlxPoint p1 = tmp2;		HX_STACK_VAR(p1,"p1");
	HX_STACK_LINE(77)
	...
	HX_STACK_LINE(77)
	::flixel::math::FlxPoint p2 = tmp3;		HX_STACK_VAR(p2,"p2");
	HX_STACK_LINE(78)
	...
	p2->set_y(tmp25);
	HX_STACK_LINE(82)
	Float tmp26 = (p1->x * p1->x);		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(82)
	Float tmp27 = (p1->y * p1->y);		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(82)
	...
	HX_STACK_LINE(83)
	Float tmp30 = (p1->x * p2->x);		HX_STACK_VAR(tmp30,"tmp30");
	HX_STACK_LINE(83)
	Float tmp31 = (p1->y * p2->y);		HX_STACK_VAR(tmp31,"tmp31");
	HX_STACK_LINE(83)
	...
	HX_STACK_LINE(84)
	Float tmp34 = (p2->x * p2->x);		HX_STACK_VAR(tmp34,"tmp34");
	HX_STACK_LINE(84)
	Float tmp35 = (p2->y * p2->y);		HX_STACK_VAR(tmp35,"tmp35");
	HX_STACK_LINE(84)
