...
Float QuadPath_obj::getCurveLength( ::flixel::math::FlxPoint start,::flixel::math::FlxPoint control,::flixel::math::FlxPoint finish){
	...
	p2->set_y(tmp17);
	HX_STACK_LINE(208)
	Float tmp18 = (p1->x * p1->x);		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(208)
	Float tmp19 = (p1->y * p1->y);		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(208)
	...
	HX_STACK_LINE(209)
	Float tmp22 = (p1->x * p2->x);		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(209)
	Float tmp23 = (p1->y * p2->y);		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(209)
	...
	HX_STACK_LINE(210)
	Float tmp26 = (p2->x * p2->x);		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(210)
	Float tmp27 = (p2->y * p2->y);		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(210)
