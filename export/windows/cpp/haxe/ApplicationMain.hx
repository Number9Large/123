...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ME", "Minimum", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Minimum";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Minimum", null, { width: 640, height: 480 });
